...
// Names the compile unit. Content shared with req42 through tagged includes is
// converted twice, once here and once there, and an anchor only resolves in the
// document that defines it. Shared text asks this attribute which side it is on.
:is-arc42:
