...
// Names the compile unit — see the note in arc42.adoc. Tagged regions below are
// included into arc42 as well and are converted in both documents.
:is-req42:
...
<<<<
include::req42-chapters/04_functional-requirements.adoc[]
...
<<<<
include::req42-chapters/11_roadmap-backlog.adoc[]
